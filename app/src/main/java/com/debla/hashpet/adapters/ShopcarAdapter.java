...
public class ShopcarAdapter extends BaseExpandableListAdapter {
    ...
    public ShopcarAdapter(List<StoreInfo> groups, Map<String, List<GoodsInfo>> childrens, Context mcontext) {
        this.groups = groups;
        this.childrens = childrens;
        this.mcontext = mcontext;
        imageLoader = new ImageLoader(mcontext);
        url = HttpUtil.getUrl(mcontext)+"/getGoodsImage";
    }
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (child != null) {
            ...
            imageLoader.DisplayImage(url+"?goodsId="+child.getId(),childViewHolder.goodsImage);
            //childViewHolder.goodsImage.setImageResource(R.drawable.cmaz);

            childViewHolder.goods_size.setText("名称:" + child.getName());
            //设置打折前的原价
